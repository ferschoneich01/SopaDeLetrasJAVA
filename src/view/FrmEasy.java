...
public class FrmEasy extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/resources/icon-easy.png"))); // NOI18N
        jLabel1.setText("SOPA DE LETRAS NIVEL FACIL");
...
//    verifica si se puede tachar la letra
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(FrmEasy.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
