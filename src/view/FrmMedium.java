...
public class FrmMedium extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        p5.setBackground(new java.awt.Color(255, 153, 51));
        ...
        p9.setBackground(new java.awt.Color(255, 153, 51));
        ...
        p10.setBackground(new java.awt.Color(255, 153, 51));
        ...
        jLabel1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/resources/icon-medium.png"))); // NOI18N
        jLabel1.setText("SOPA DE LETRAS NIVEL MEDIO");
...
//    verifica si se puede tachar la letra
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(FrmMedium.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
